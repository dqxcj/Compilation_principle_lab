...
> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [blog.csdn.net](https://blog.csdn.net/qq_36663518/article/details/119577717?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522166780574416782388027776%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=166780574416782388027776&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~top_click~default-2-119577717-null-null.142^v63^opensearch_v2,201^v3^add_ask,213^v1^t3_control2&utm_term=vim%E5%BF%AB%E6%8D%B7%E9%94%AE&spm=1018.2226.3001.4187)
...
[vim](https://so.csdn.net/so/search?q=vim&spm=1001.2101.3001.7020) 是我最喜欢的编辑器，也是 linux 下第二强大的编辑器。 虽然 emacs 是公认的世界第一，我认为使用 emacs 并没有使用 vi 进行编辑来得高效。 如果是初学 vi，运行一下 vimtutor 是个聪明的决定。 （如果你的系统环境不是中文，而你想使用中文的 vimtutor，就运行 vimtutor zh）
